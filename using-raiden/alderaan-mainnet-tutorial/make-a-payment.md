---
description: >-
  Once you're connected to the W-ETH token network, have open channels with one
  or more peers and tokens deposited into the channels you're all set to start
  making payments.
---
...
```text
curl -i -X POST \
http://localhost:5001/api/v1/payments/0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2/0x61C808D82A3Ac53231750daDc13c777b59310bD9 \
